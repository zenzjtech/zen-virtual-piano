...
Update `wxt.config.ts` to support localized names/descriptions ✅ COMPLETED

### **Phase 5: Language Switcher UI** (Impact: Small, Risk: Low)

#### 5.1 Add Language Selector
**Location:** Settings dialog or Header ✅ COMPLETED
...
1. **Install react-i18next dependencies** ✅ COMPLETED
2. **Create i18n infrastructure** (`src/lib/i18n/`) ✅ COMPLETED
3. **Set up Redux slice** for locale management ✅ COMPLETED
4. **Create translation hook** (`useTranslation`) ✅ COMPLETED
